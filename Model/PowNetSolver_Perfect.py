...
run_no = 0
FC_typ = 'perfect' #'perfect','clim','FC'
...
if FC_typ == 'FC':
    ...
    if len(res_reop) == 0:
        path = 'results/'+FC_name+'/'
    else:
        path = 'results/'+FC_name+'_withFB/'
...
if FC_typ == 'FC':
    ...
    if len(res_reop) == 0:
        dat_name = 'pownet_data_Camb_'+FC_name
    else: 
        dat_name = 'pownet_data_Camb_'+FC_name+'_FB'
...
# https://stackoverflow.com/questions/71104593/create-a-list-of-values-from-nested-dictionary-python
...
def postprocess():
    ...
    for name in instance.h_nodes:
        ...
        if FC_typ == 'FC':
            ...
            res_all.to_csv(path+name+'_'+FC_typ[:4]+'.csv',index=False)
